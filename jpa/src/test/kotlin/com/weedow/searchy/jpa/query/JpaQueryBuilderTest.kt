package com.weedow.searchy.jpa.query
...
internal class JpaQueryBuilderTest {
    ...
    fun join_map_entries(elementType: ElementType) {
        ...
        whenever(searchyContext.getAllPropertyInfos(entityClass)).thenReturn(emptyList())
        ...
        assertThat(join).extracting("qEntity")
            ...
            .extracting("searchyContext")
            .isSameAs(searchyContext)
    ...
    private fun <T> verifyJoinWithAlias(
        ...
        whenever(searchyContext.get(eq(entityClass), any())).thenReturn(qEntityAlias)
