...
class DataSearchJpaRepositoryImpl<T, ID : Serializable>(
    ...
    private val factory: JpaQueryDslSpecificationExecutorFactory = JpaQueryDslSpecificationExecutorFactory(entityManager, dataSearchContext)
    private val queryDslSpecificationExecutor: QueryDslSpecificationExecutor<T> = factory.getQueryDslSpecificationExecutor(domainClass)
