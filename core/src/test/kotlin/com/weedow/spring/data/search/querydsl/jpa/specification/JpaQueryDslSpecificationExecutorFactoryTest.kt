...
internal class JpaQueryDslSpecificationExecutorFactoryTest {
    ...
    @InjectMocks
    private lateinit var jpaQueryDslSpecificationExecutorFactory: JpaQueryDslSpecificationExecutorFactory
    ...
    private fun <T> verify(entityClass: Class<T>) {
        ...
        val specificationExecutor = jpaQueryDslSpecificationExecutorFactory.getQueryDslSpecificationExecutor(entityClass)

        assertThat(specificationExecutor)
            .isInstanceOf(JpaQueryDslSpecificationExecutor::class.java)
            .extracting("dataSearchContext", "entityManager", "metadata")
            .contains(dataSearchContext, entityManager, null)
