...
internal class ValidationExceptionTest {
    ...
    fun test_with_default_arguments() {
        val error1 = DataSearchError("4001", "This is the first error")
        val error2 = DataSearchError("4002", "This is the second error")
    ...
    fun test_with_custom_arguments() {
        val error1 = DataSearchError("5001", "This is the first error")
        val error2 = DataSearchError("5002", "This is the second error")
