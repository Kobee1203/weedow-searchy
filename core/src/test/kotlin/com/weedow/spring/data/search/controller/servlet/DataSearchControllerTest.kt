...
internal class DataSearchControllerTest {
    ...
    fun setUp() {
        ...
        val mapping = RequestMappingInfo
                ...
                .build()
        verify(requestMappingHandlerMapping).registerMapping(mapping, dataSearchController, DataSearchController::class.java.getMethod("search", String::class.java, MultiValueMap::class.java))
    }
