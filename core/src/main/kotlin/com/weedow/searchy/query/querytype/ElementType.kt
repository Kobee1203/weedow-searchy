...
enum class ElementType(
    ...
    private val supportFunction: (Class<*>, searchyContext: SearchyContext) -> Boolean
) {
    ...
    companion object {
        ...
        fun get(clazz: Class<*>, searchyContext: SearchyContext): ElementType {
            return values().first { elementType -> elementType.supports(clazz, searchyContext) }
        }
    }

    private fun supports(clazz: Class<*>, searchyContext: SearchyContext): Boolean {
        return this.supportFunction(clazz, searchyContext)
    }
