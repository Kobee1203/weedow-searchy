...
import com.weedow.searchy.validation.validator.EmailValidator.Companion.DEFAULT_PATTERN
 ...
 * @param pattern Pattern String used to check if the value matches this given pattern. Default is [DEFAULT_PATTERN]
 */
