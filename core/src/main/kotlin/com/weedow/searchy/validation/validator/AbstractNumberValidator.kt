...
abstract class AbstractNumberValidator(
     ...
     */
    abstract fun doValidate(value: Number, fieldExpression: FieldExpression, errors: SearchyErrors)

    final override fun validateSingle(value: Any, fieldExpression: FieldExpression, errors: SearchyErrors) {
        if (value !is Number) {
            errors.reject(
                "not-a-number",
