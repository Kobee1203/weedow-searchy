 ...
 *
 * Consolidates the read-only operations exposed by [SearchDescriptorService] and the mutating operations of [SearchDescriptorRegistry] to allow for convenient ad-hoc addition and removal of [SearchDescriptor] through.
 */
